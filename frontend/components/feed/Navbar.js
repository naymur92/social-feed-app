    ...
    <>
      ...
      <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
        <div className="container _custom_container">
          ...
          <button className="navbar-toggler bg-light" type="button" onClick={() => setNavOpen(!navOpen)} aria-controls="navbarSupportedContent" aria-expanded={navOpen} aria-label="Toggle navigation"> <span className="navbar-toggler-icon"></span>
          </button>
          <div className={`collapse navbar-collapse${navOpen ? " show" : ""}`} id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
              ...
              <li className="nav-item _header_nav_item">
                <span className="nav-link _header_nav_link _header_notify_btn" onClick={() => setNotifOpen(!notifOpen)} role="button">
                  ...
                  <div className="_notification_dropdown" style={notifOpen ? { display: "block", visibility: "visible", opacity: 1, transform: "none" } : undefined} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="_header_nav_profile">
              <div className="_header_nav_profile_image">
                <Avatar src={user?.profile_picture} name={user?.full_name || ""} size={40} className="_nav_profile_img" />
              </div>
              <div className="_header_nav_dropdown">
                <p className="_header_nav_para">{user?.full_name}</p>
                <button className="_header_nav_dropdown_btn _dropdown_toggle" type="button" onClick={() => setProfileOpen(!profileOpen)}>
              ...
              {/* dropdown */}
              <div className="_nav_profile_dropdown _profile_dropdown" style={profileOpen ? { display: "block", visibility: "visible", opacity: 1, transform: "none" } : undefined}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <Avatar src={user?.profile_picture} name={user?.full_name || ""} size={48} className="_nav_drop_img" />
                  </div>
